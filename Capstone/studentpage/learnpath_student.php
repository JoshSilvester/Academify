...
<head>
    ...
    <link rel="stylesheet" href="../css/student_MainPage_learnpath.css">
</head>
...
<div class="STUDENT-back">
        <a href="../studentpage/mainpage.php" class="STUDENT-back-style-path">Back</a>
    </div>

    <div class="center-box-learnpath">
                ...
                echo '
                        <td>
                            <table class="subject-table">
                                <tr>
                                    <td> <a href="pathmaterial_student.php?id=' . $display['path_id'] . '"><img src="../foto_pelajaran/' . $display['path_img'] . '"</td>
                                </tr>
                                <tr> 
